  ...
  if (securitySettings.loading) {
    return (
      <View style={[styles.container, { backgroundColor: colors.background }]}>
        <Typography variant="bodyMd" color={colors.textSecondary} style={styles.loading}>
          Loading settings...
        </Typography>
      </View>
    );
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        />
        <AppearanceSection isDark={appSettings.isDark} toggleTheme={appSettings.toggleTheme} />
        <DataSection
      ...
      <NumericPasswordModal
        ...
        onSuccess={(password: string) => void passwordSettings.handlePasswordSet(password)}
